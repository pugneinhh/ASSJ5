...
<main id="main" class="main">
    <h1 class="text-center fw-bolder">UPDATE DÒNG MÀU SẮC</h1>
    <div class="container " style="margin: 0 auto;border: gray solid 1px; border-radius: 10px; padding: 20px 20px;">
        <%--@elvariable id="ms" type=""--%>
        <form:form action="/mau-sac/update" modelAttribute="ms">
            <div class="row">
                <form:input type="hidden" class="form-control" path="id" value="${ms.id}"/>
