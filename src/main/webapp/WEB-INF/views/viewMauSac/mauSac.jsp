...
<main id="main" class="main">
    <h1 class="text-center fw-bolder">QUẢN LÝ MÀU SẮC</h1>
    <div class="container " style="margin: 0 auto;border: gray solid 1px; border-radius: 10px; padding: 20px 20px;">
        <%--@elvariable id="ms" type=""--%>
        <form:form action="/mau-sac/add" modelAttribute="ms">
            <div class="row">

            <div class="form-group col-md-6 mt-3">
                <h3>Mã:</h3>
                <form:input class="form-control" path="ma" value="${ms.ma}"/>
                <p style="color: red">${LOIMA}</p>
            </div>

            <div class="form-group col-md-6 mt-3">
                <h3>Tên:</h3>
                <form:input class="form-control" path="ten" value="${ms.ten}"/>
    ...
    <div class="container">
        <table class="table table-stripped">
            ...
            <tbody>
            <c:forEach var="s" items="${LISTMS}">
                <tr>
                    <td>${s.id}</td>
                    <td>${s.ma}</td>
                    <td>${s.ten}</td>
                    <td>
                        <a href="/mau-sac/detail/${s.id}" class="btn btn-success">Detail</a>
                        <a href="/mau-sac/view-update/${s.id}" class="btn btn-primary">Update</a>
                        <a href="/mau-sac/delete/${s.id}" onclick="return confirm('Bạn có muốn xóa màu sắc này k')" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
