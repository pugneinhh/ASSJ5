...
<main id="main" class="main">
    <h1 class="text-center fw-bolder">UPDATE SẢN PHẨM</h1>
    <div class="container " style="margin: 0 auto;border: gray solid 1px; border-radius: 10px; padding: 20px 20px;">
        <%--@elvariable id="sp" type=""--%>
        <form:form action="/san-pham/update" modelAttribute="sp">
            <div class="row">
                <form:input type="hidden" class="form-control" path="id" value="${sp.id}"/>
