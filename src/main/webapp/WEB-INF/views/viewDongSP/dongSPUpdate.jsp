...
<main id="main" class="main">
    <h1 class="text-center fw-bolder">QUẢN LÝ DÒNG SẢN PHẨM</h1>
    <div class="container " style="margin: 0 auto;border: gray solid 1px; border-radius: 10px; padding: 20px 20px;">
        <%--@elvariable id="dsp" type=""--%>
        <form:form action="/dongSP/update" modelAttribute="dsp">
            <div class="row">
                <form:input type="hidden" class="form-control" path="id" value="${dsp.id}"/>
            <div class="form-group col-md-6 mt-3">
                <h3>Mã:</h3>
                <form:input class="form-control" path="ma" value="${dsp.ma}"/>
                <p style="color: red">${LOIMA}</p>
            </div>

            <div class="form-group col-md-6 mt-3">
                <h3>Tên:</h3>
                <form:input class="form-control" path="ten" value="${dsp.ten}"/>
