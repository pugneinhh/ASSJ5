...
<main id="main" class="main">
    <h1 class="text-center fw-bolder">UPDATE NHÀ SẢN XUẤT</h1>
    <div class="container " style="margin: 0 auto;border: gray solid 1px; border-radius: 10px; padding: 20px 20px;">
        <%--@elvariable id="nsx" type=""--%>
        <form:form action="/nsx/update" modelAttribute="nsx">
            <div class="row">
                <form:input type="hidden" class="form-control" path="id" value="${nsx.id}"/>
