...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="/trang-chu/" class="logo d-flex align-items-center">
...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="/trang-chu/login">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="/trang-chu/login">
...
<main id="main" class="main">
    <h1 class="text-center fw-bolder">QUẢN LÝ CHỨC VỤ</h1>
    <div class="container " style="margin: 0 auto;border: gray solid 1px; border-radius: 10px; padding: 20px 20px;">
        <%--@elvariable id="cv" type=""--%>
        <form:form action="/chuc-vu/add" modelAttribute="cv">
            <div class="row">

            <div class="form-group col-md-6 mt-3">
                <h3>Mã:</h3>
                <form:input class="form-control" path="ma" value="${cv.ma}"/>
                <p style="color: red">${LOIMA}</p>
            </div>

            <div class="form-group col-md-6 mt-3">
                <h3>Tên:</h3>
                <form:input class="form-control" path="ten" value="${cv.ten}"/>
                <p style="color: red">${LOITEN}</p>
            </div>
                <div class="row">   <button class="btn btn-primary mt-3 col-sm-2 justify-content-center" style="margin:2px auto;">Thêm</button></div>
        ...
        <table class="table table-stripped">
            ...
            <c:forEach var="s" items="${list}">
                <tr>
                    ...
                    <td>${s.ten}</td>
                    <td>
                        <a href="/chuc-vu/detail/${s.id}" class="btn btn-success">Detail</a>
                        <a href="/chuc-vu/view-update/${s.id}" class="btn btn-primary">Update</a>
                        <a href="/chuc-vu/delete/${s.id}" onclick="return confirm('Bạn có muốn xóa cửa hàng này k')" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
