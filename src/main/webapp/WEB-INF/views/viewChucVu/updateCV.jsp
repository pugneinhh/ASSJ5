...
<main id="main" class="main">
    ...
    <div class="container " style="margin: 0 auto;border: gray solid 1px; border-radius: 10px; padding: 20px 20px;">
        ...
        <form:form action="/chuc-vu/update" modelAttribute="cv">
            <div class="row">
                <form:input value="${cv.id}" type="hidden" path="id"/>
            ...
            <div class="form-group col-md-6 mt-3">
                ...
                <div class="row">   <button class="btn btn-primary mt-3 col-sm-2 justify-content-center" style="margin:2px auto;">Update</button></div>
