...
<main id="main" class="main">
        ...
        <div class="container">
                ...
                <table class="table table-stripedư">
                    <thead>
                    <tr>
                        <th>STT</th>
                        <th>Hình</th>
                    ...
                    <tbody>
                    <c:forEach varStatus="stt" var="c" items="${LIST_CTSP}">
                        <form action="/ban-hang/mua-hang" method="post">
                        <tr>
                            <td>${stt.index+1}</td>
                            ...
                            <td>${c.slt}</td>
                            <td>${c.giaBan}</td>
                            <td><input name="soLuong"/></td>
                            <td>
                                <input name="idHD" value="${idHD}" type="hidden"/>
                                <input name="idSP" value="${c.id}" type="hidden"/>
