                    ...
                    <div class="container">
                        <table class="table table-striped" style="margin-top: 50px;">
                            ...
                            <tr>
                                ...
                                <th class="pe-4 text-nowrap">Hình ảnh</th>
                            ...
                            <tbody>
                            <c:forEach var="h" items="${LIST_HDCT}" varStatus="stt">
                                <tr>
                                    <td>${stt.index+1}</td>
                                    <td><img src='/hinh/${h.id.idChiTietSp.hinh}' style="width: 150px;height: 150px" alt=""></td>
